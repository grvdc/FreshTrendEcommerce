...
var ShopPagePage = /** @class */ (function () {
    function ShopPagePage(auth, router, route, loadingController) {
        var _this = this;
        this.auth = auth;
        this.router = router;
        this.route = route;
