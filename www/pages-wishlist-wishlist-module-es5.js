...
var WishlistPage = /** @class */ (function () {
    ...
    WishlistPage.prototype.gotoHome = function () {
    ...
    WishlistPage.prototype.swipeLeft = function (event, index) {
        console.log('Swipe Left', event);
    };
    WishlistPage.prototype.swipeRight = function (event, index) {
