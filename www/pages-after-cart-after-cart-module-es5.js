...
var AfterCartPage = /** @class */ (function () {
    ...
    AfterCartPage.prototype.recheck = function () {
    ...
    AfterCartPage.prototype.emailvalidate = function () {
        if (this.form.email == '') {
            this.emailtest = true;
            // return false;
        }
    ...
    AfterCartPage.prototype.toInfo = function () {
        this.infoSection = true;
        this.shippingAddressSection = false;
        this.paymentSection = false;
    };
    ...
    //   return false; 
    // }
    AfterCartPage.prototype.ionViewDidEnter = function () {
        document.addEventListener("backbutton", function (e) {
            console.log("disable back button");
        }, false);
    };
    AfterCartPage.prototype.toShip = function () {
        this.infoSection = false;
        this.shippingAddressSection = true;
        this.paymentSection = false;
    };
    AfterCartPage.prototype.toPayment = function () {
        this.infoSection = false;
        this.shippingAddressSection = false;
        this.paymentSection = true;
    };
    AfterCartPage.prototype.validateDifferent = function () {
